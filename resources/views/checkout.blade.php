					...
					<div class="col-md-6 order-details">
						...
						<div class="order-col">
							...
							<div class="form-group">
								...
								@foreach($voucher as $limit)
								@php $bal = 0 @endphp				
								  @php $bal += $limit['credit'] - $total   @endphp
						
								
								<div class="order-col">
								<div><strong>Credit Limit</strong> <span class="text-danger"><i class="fa fa-credit-card"></i></span></div>

								<div id="credit">
									<strong class="order-total">
									₦{{ number_format($limit->credit) }}
								</strong></div>

								</div><!--order-col--->

								<input type="hidden" name="" id="credit" value="{{$limit['credit']}}" oninput="myFunction">
								<input type="hidden" name="bal" id="bal" value="{{ $bal }}" oninput="myFunction"><!-- account balance-->
							...
							<!-- hide-->
								<div class="form-group" id="#hide">
									<a href="{{ route('cart')}}" class="text-primary">Modify Your Order.
